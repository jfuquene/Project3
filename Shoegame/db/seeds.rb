...
yeezyboost = Shoe.create(shoes_size: 10.5, color:"white", price: 200, brand:"adidas", image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTULlAynME9GWZuUVjvaTEUhIdNOGoWEejPjgw4uST7Ue0cwpWAouTiuw6GGJADx-ZyLzP1Ilcw&usqp=CAc", name: "Yeezyboost 700", sex:"male")
...
user10 = User.create(username:"John Cena")
...
classic_high = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"converse", image:"https://www.converse.com/dw/image/v2/BCZC_PRD/on/demandware.static/-/Sites-cnv-master-catalog/default/dwdd05c312/images/a_107/M9160_A_107X1.jpg?sw=964", name:"All Star (High-top)", sex:"unisex")
...
chuck70_low = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"converse", image:"https://www.converse.com/dw/image/v2/BCZC_PRD/on/demandware.static/-/Sites-cnv-master-catalog/default/dwa4efce0f/images/a_107/162065C_A_107X1.jpg?sw=964", name:"Chuck 70's (low-top)", sex:"unisex")

chuck70_high = Shoe.create(shoes_size: 10, color:"black", price: 200, brand:"converse", image:"https://www.converse.com/dw/image/v2/BCZC_PRD/on/demandware.static/-/Sites-cnv-master-catalog/default/dw88ddaf6e/images/a_107/162050C_A_107X1.jpg?sw=964", name:"Chuck 70's (high-top)", sex:"unisex")


#////////////////nike//////////////////

roshes = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"nike", image:"https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/riur8c6bz6wpakhlgwxl/roshe-one-mens-shoe-MkTmzjJv.jpg", name:'Roshes', sex:"unisex")

kyrie6 = Shoe.create(shoes_size: 10, color:"white", price: 100, brand:"nike", image:"https://media.finishline.com/i/finishline/CK5869_101_P1?$Main_gray$&bg=rgb(237,237,237)", name:"Kyrie 6's", sex:"male")

jordan1 = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"nike", image:"https://cdn.shopify.com/s/files/1/0267/9232/9325/files/555088-134-1_480x480.jpg?v=1614889351", name:"Jordan 1's", sex:"unisex")

airmax = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"nike", image:"https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/zwxes8uud05rkuei1mpt/air-max-90-mens-shoe-6n3vKB.jpg", name:'Air Max', sex:"unisex")

airForce = Shoe.create(shoes_size: 10, color:"white", price: 200, brand:"nike", image:"https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/4f37fca8-6bce-43e7-ad07-f57ae3c13142/air-force-1-07-mens-shoe-5QFp5Z.jpg", name:'Air Force', sex:"unisex")
...
johnCena = LikedShoe.create(shoe:yeezyboost, user:user10)